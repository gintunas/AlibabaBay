...
public class AutoPartDeluxe extends AutoPart implements Tracked, Invoiced, Returnable {
    private final Tracked trackingImpl;
    private final Invoiced invoiceImpl;
    private final Returnable returnImpl;

    public AutoPartDeluxe(BigDecimal price, String name, String description, Tracked trackingImpl, Invoiced invoiceImpl, Returnable returnImpl) {
